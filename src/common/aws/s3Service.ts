...
export class S3Service {
    ...
    constructor(private readonly configService: ConfigService) {
        ...
        this.s3Client = new S3Client({
            ...
            credentials: {
                accessKeyId: this.configService.get<string>('AWS_ACCESS_KEY_S3') || '',
                secretAccessKey: this.configService.get<string>('AWS_SECRET_ACCESS_S3') || '',
            },
        });
    }
    ...
    async getFileUrl(filekey: string, expireInSeconds: number = 3600): Promise<string> {
